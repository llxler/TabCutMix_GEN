...
import importlib
import sys
sys.path.append('E:/TabCutMix/tabsyn')
sys.path.append('E:/TabCutMix/')
sys.path.append('E:/TabCutMix/tabsyn/vae')

from tabsyn.vae import main
...
def get_args():
    ...
    # General configs
    parser.add_argument('--task_name', type=str, default="lxlernb", help='Name of the task.')
    parser.add_argument('--eval_flag', type=bool, default=False, help='Whether to evaluate the model.')
